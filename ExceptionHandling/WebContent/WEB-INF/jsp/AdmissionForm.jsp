...
<body>
<h1>${headerMessage}</h1>
<a href="/ExceptionHandling/AdmissionForm?siteLanguage=en">English</a>
<a href="/ExceptionHandling/AdmissionForm?siteLanguage=fr">French</a>
<a href="/ExceptionHandling/AdmissionForm?siteLanguage=ka">Kannada</a>
<h3> STUDENT ADMISSION FORM</h3>
<form:errors path="student1.*"/>
<form action="/ExceptionHandling/SubmissionForm">
<table>
