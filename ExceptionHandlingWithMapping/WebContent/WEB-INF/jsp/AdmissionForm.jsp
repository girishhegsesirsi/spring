...
<body>
<h1>${headerMessage}</h1>
<a href="/ExceptionHandlingWithMapping/AdmissionForm?siteLanguage=en">English</a>
<a href="/ExceptionHandlingWithMapping/AdmissionForm?siteLanguage=fr">French</a>
<a href="/ExceptionHandlingWithMapping/AdmissionForm?siteLanguage=ka">Kannada</a>
<h3> STUDENT ADMISSION FORM</h3>
<form:errors path="student1.*"/>
<form action="/ExceptionHandlingWithMapping/SubmissionForm">
<table>
