...
<body>
<h1>${headerMessage}</h1>
<a href="/MultiLang/AdmissionForm?siteLanguage=en">English</a>
<a href="/MultiLang/AdmissionForm?siteLanguage=fr">French</a>
<a href="/MultiLang/AdmissionForm?siteLanguage=ka">Kannada</a>
<h3> STUDENT ADMISSION FORM</h3>
<form:errors path="student1.*"/>
<form action="/MultiLang/SubmissionForm">
<table>
